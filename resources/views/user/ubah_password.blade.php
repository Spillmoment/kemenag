        ...
        <div class="card shadow mb-4">
            ...
            <div class="col-md-6 offset-md-3 py-5">
                ...
                <div class="card card-outline-secondary">
                    ...
                    <div class="card-body">
                        <form class="form" method="POST" action="{{ route('changepassword.update') }}"
                            autocomplete="off">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="password_sekarang">Password Saat Ini</label>
                                <input type="password" class="form-control" id="password_sekarang"
                                    name="password_sekarang" class="password_sekarang" required="">
                            </div>
                            <div class="form-group">
